...
function IconPersonalised() {
  return (
    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="14" cy="14" r="3.5" fill="var(--bl-cream)" />
    </svg>
  );
}
...
function IconConnected() {
  return (
    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="14" cy="18" r="2.5" fill="var(--bl-cream)" />
    </svg>
  );
}
...
function IconIntelligent() {
  return (
    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="20" y="4" width="4" height="20" rx="1" fill="var(--bl-cream)" />
    </svg>
  );
}
  ...
  return (
    <>
      ...
      <section className={styles.inventory}>
        <div className={styles.container}>
          <span className={styles.label} style={{ color: "var(--bl-midnight)" }}>
            Screen Inventory
          </span>
          <h2 className={styles.title} style={{ color: "var(--bl-deep-inhale)" }}>
            V1 → V2 Screen Map
          </h2>
